...
desc: 'Smart road monitoring system for detecting potholes and road conditions using NodeMCU and SIM800L for remote data communication with real-time intelligent reporting.',
...
info: { Domain: 'IoT / AI', Stack: 'NodeMCU · SIM800L · Python', Started: '2024 Q1', Target: '2024 Q4', Type: 'Embedded / IoT' },
github: 'https://github.com/nzivommoses',
demo: null,
},
{
id: 'p2',
...
desc: 'Automated solar panel orientation system using LDR sensors, servo motors, and D1 Mini microcontroller with wireless communication for renewable energy optimisation.',
tags: ['D1 Mini', 'LDR Sensors', 'Servo Motors', 'ESP-NOW'],
started: '2023',
overview: 'A dual-axis solar tracking system that continuously orients a solar panel toward the sun to maximise energy capture. LDR sensors detect light intensity differentials; servo motors execute orientation corrections. Wireless communication links the outdoor tracking unit to an indoor monitoring dashboard.',
objectives: [
'Design LDR-based light differential sensing circuit',
'Implement servo motor control on D1 Mini',
'Build wireless indoor-outdoor communication link',
'Optimise tracking algorithm for energy yield',
...
info: { Domain: 'Embedded / Energy', Stack: 'D1 Mini · LDR · KiCad', Started: '2023 Q2', Target: '2024 Q1', Type: 'Hardware Project' },
github: 'https://github.com/nzivommoses',
demo: null,
},
{
...
desc: 'Integrated home automation system with motion detection, light sensing, relay control, and Bluetooth audio using ESP32 — with planned PCB modules for indoor and outdoor use.',
tags: ['ESP32', 'Bluetooth', 'Relay', 'PIR Sensor'],
started: '2023',
overview: 'A unified smart home system built on the ESP32 platform that combines automated lighting (motion + ambient light sensing), relay-switched appliance control, and Bluetooth audio streaming into a single embedded solution. PCB layouts were planned for clean indoor and outdoor module installations.',
objectives: [
...
approach: 'The ESP32 runs FreeRTOS tasks for sensor polling, relay control, and Bluetooth audio concurrently. A simple rule engine triggers lighting based on motion presence and ambient lux thresholds. The Bluetooth audio stack streams audio from a paired phone to a connected speaker amplifier board.',
milestones: [
...
info: { Domain: 'Embedded / IoT', Stack: 'ESP32 · Bluetooth · KiCad', Started: '2023 Q1', Target: '2024 Q1', Type: 'Hardware / Firmware' },
github: 'https://github.com/nzivommoses',
demo: null,
},
{
...
desc: 'Lightweight bird-style ornithopter drone using recycled materials, ESP-NOW wireless control, and embedded firmware for wing motion and tail stabilisation.',
...
approach: 'The airframe uses carbon-fibre rods and recycled plastic film for minimal weight. Two servos drive the wing crank mechanism; a third controls tail deflection. The ESP32 controller runs a real-time servo mixer and receives commands from a handheld ESP32 transmitter via ESP-NOW.',
milestones: [
